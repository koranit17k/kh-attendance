...
const testCases = [
    {
        ...
        exp: { work: 480, lunch: 60, ot: 0, late1: 0, late2: 0, mlunch: 0 },
    },
    {
        id: 2,
        scenario: "Normal 2",
        scans: ["07:50:00", "12:14:00", "12:45:00", "17:30:00"],
        exp: { work: 480, lunch: 31, ot: 0, late1: 0, late2: 0, mlunch: 0 },
    },
    {
        id: 3,
        scenario: "Normal 3",
        scans: ["07:50:00", "12:14:00", "12:45:00", "16:30:00"],
        exp: { work: 450, lunch: 31, ot: 0, late1: 0, late2: 30, mlunch: 0 },
    },
    {
        id: 4,
        scenario: "OT Night 1",
        scans: ["06:54:00", "12:32:00", "12:54:00", "17:31:00", "21:12:00"],
        exp: { work: 480, lunch: 22, ot: 192, late1: 0, late2: 0, mlunch: 0 },
    },
    {
        id: 5,
        scenario: "OT Night 2",
        scans: ["07:32:00", "12:10:00", "12:55:00", "21:10:00"],
        exp: { work: 480, lunch: 45, ot: 190, late1: 0, late2: 0, mlunch: 0 },
    },
    {
        id: 6,
        scenario: "OT Night 3",
        scans: ["12:12:00", "12:55:00", "21:30:00"],
        exp: { work: 240, lunch: 43, ot: 0, late1: 0, late2: 0, mlunch: 0 },
    },
    {
        id: 7,
        scenario: "OT Early",
        scans: ["07:35:00", "12:05:00", "12:57:00", "02:02:00"],
        exp: { work: 480, lunch: 52, ot: 482, late1: 0, late2: 0, mlunch: 0 },
    },
    {
        id: 8,
        scenario: "Missing Lunch 1",
        scans: ["07:38:00", "17:03:00"],
        exp: { work: 240, lunch: 0, ot: 0, late1: 0, late2: 0, mlunch: 240 },
    },
    {
        id: 9,
        scenario: "Missing Lunch 2",
        scans: ["07:50:00", "12:34:00", "17:05:00"],
        exp: { work: 360, lunch: 0, ot: 0, late1: 0, late2: 0, mlunch: 120 },
    },
    {
        id: 10,
    ...
    },
    {
        ...
        exp: { work: 480, lunch: 48, ot: 151, late1: 0, late2: 0, mlunch: 0 },
    },
    {
        id: 12,
        scenario: "morning+MLunch+OT 1",
        scans: ["07:39:00", "20:11:00"],
        exp: { work: 240, lunch: 0, ot: 131, late1: 0, late2: 0, mlunch: 240 },
    },
    {
        id: 13,
        scenario: "morning+MLunch+OT 2",
        scans: ["07:23:00", "12:22:00", "20:58:00"],
        exp: { work: 360, lunch: 0, ot: 178, late1: 0, late2: 0, mlunch: 120 },
    },
    {
        id: 14,
        scenario: "morning+MLunch+OT 3",
        scans: ["07:23:00", "14:02:00", "20:05:00"],
        exp: { work: 360, lunch: 0, ot: 125, late1: 0, late2: 0, mlunch: 120 },
    },
    {
        id: 15,
        scenario: "morning+MLunch+early",
        scans: ["07:21:00", "02:08:00"],
        exp: { work: 240, lunch: 0, ot: 488, late1: 0, late2: 0, mlunch: 240 },
    },
    {
        id: 16,
        scenario: "Half Day Morning 1",
        scans: ["07:41:00", "11:45:00"],
        exp: { work: 225, lunch: 0, ot: 0, late1: 0, late2: 15, mlunch: 0 },
    },
    {
        id: 17,
    ...
    },
    {
        ...
        exp: { work: 230, lunch: 0, ot: 0, late1: 0, late2: 10, mlunch: 0 },
    },
    {
        id: 19,
    ...
    },
    {
        ...
        exp: { work: 455, lunch: 51, ot: 0, late1: 20, late2: 5, mlunch: 0 },
    },
    {
        id: 21,
        scenario: "Late Morning Half",
        scans: ["08:30:00", "12:20:00"],
        exp: { work: 210, lunch: 0, ot: 0, late1: 30, late2: 0, mlunch: 0 },
    },
    {
        id: 22,
        scenario: "Late Lunch",
        scans: ["07:30:00", "12:01:00", "13:23:00", "17:03:00"],
        exp: { work: 458, lunch: 82, ot: 0, late1: 0, late2: 22, mlunch: 0 },
    },
    {
        id: 23,
        scenario: "Spam Morning",
        scans: ["07:50:00", "08:02:00", "08:05:00", "16:55:00"],
        exp: { work: 230, lunch: 0, ot: 0, late1: 5, late2: 5, mlunch: 240 },
    },
    {
        id: 24,
        scenario: "Spam Lunch Out",
        scans: ["07:30:00", "11:54:00", "12:05:00", "12:10:00", "17:09:00"],
        exp: { work: 480, lunch: 16, ot: 0, late1: 0, late2: 0, mlunch: 0 },
    },
    {
        id: 25,
        scenario: "Absent 1",
    ...
    },
    {
        ...
        exp: { work: 0, lunch: 60, ot: 0, late1: 0, late2: 0, mlunch: 0 },
    },
    {
        id: 30,
        scenario: "Absent 6",
...
describe("Attendance System Verification (Year 3000)", () => {
    ...
    test.each(testCases)("Scenario $id: $scenario", async ({ id, scenario, exp }) => {
        ...
        const mlunch = getVal(actual?.missing_lunch_minutes)
        ...
        expect(mlunch, msg("Missing Lunch Minutes", exp.mlunch, mlunch)).toBe(exp.mlunch)
    })
})
